...
class Solve {
    public static void main(String[] args) {
        solution("01__f--skfj..ew234..56789-.....");
    }
    public static String solution(String new_id) {
        ...
        System.out.println(dot_start+" "+dot_end);
        while(dot_start >=0){
        ...
        if(temp_id.length()==1) temp_id.insert(0,'a');
        ...
        //System.out.println(temp_id.append('a'));

        //7단계
        System.out.println("len: "+temp_id.length()+" "+temp_id.charAt(temp_id.length()-2));
        while(temp_id.length()<4) temp_id.insert(temp_id.length()-1,temp_id.charAt(temp_id.length()-2));
        System.out.println("7단계 해결"+temp_id);

        return (temp_id.deleteCharAt(temp_id.length()-1)).toString();
        //System.out.println(new_id);
        //String answer = "";
        //return answer;
    }
